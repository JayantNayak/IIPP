...
class Ship:
    ...
    def shoot(self,missile):
        """
        missile.pos[0]=self.pos[0]+0.045*self.pos[0]
        missile.pos[1]=self.pos[1]+0.045*self.pos[1]
        """
        missile.pos[0]=self.pos[0]+280*self.forward[0]
        missile.pos[1]=self.pos[1]+280*self.forward[1]
...
def rock_spawner():
    ...
    a_rock.angle_vel=random.choice([1,-1])*(random.random()%.25)
...
#my_ship = Ship([WIDTH / 2, HEIGHT / 2], [1, -1], 0, ship_image, ship_info) #for testing only
